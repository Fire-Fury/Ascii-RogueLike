...
public class GoblinAi extends CreatureAi{
	...
	public void onUpdate()
	{
		...
		else if(canRangedAttack(player))
		{
	...
	//Helpers
	private boolean canRangedAttack(Creature other)
	{
	...
	private Item getWeaponToThrow()
	{
		...
		{
			if(i == null || creature.weapon() == i || creature.armor() == i)
			{
				continue;
			}
			if(toThrow == null || i.thrownAttackValue() > toThrow.thrownAttackValue())
			{
				toThrow = i;
			}
		}
